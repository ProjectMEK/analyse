...
%
  ...
  case 'ouverture'
    ...
    th.titre(1) =uicontrol('Parent',th.fig(1), ...
            ...
            'String','Choix des canal/aux à différencier', ...
            'Style','text');
  ...
  case 'travail'
    dtchnl =CDtchnl();
    Vcan =get(th.control(1),'Value')';                        % 'canaux à différencier
    nouveau =abs(get(th.control(2),'Value')-1);               % on écrase le canal source
