...
function fig =IModeXY(Papa)
  ...
  fig =figure('Name','MODE X-Y','tag', 'IpChoiXY',...
       ...
       'CloseRequestFcn',@Papa.mnucacher,...
  ...
  elTexto ={'Parent';fig; 'BackgroundColor';[1 1 1]; 'Callback';@Papa.mnuvoircan; ...
  ...
  item =uimenu(conmnu, 'Label', 'Effacer les lignes sélectionnées', 'Callback', @Papa.effacer);
  item =uimenu(conmnu, 'Label', 'Effacer Toutes les lignes', 'Callback', @Papa.effaceles);
  ...
  elTexto ={'Parent';fig; 'BackgroundColor';[1 1 1]; 'Callback';@Papa.editcan;...
  ...
  uicontrol('Parent',fig, 'tag','IpAxeTemps', 'Callback',@Papa.deroultemps, 'enable',actif, ...
  ...
  uicontrol('Parent',fig, 'BackgroundColor',[1 1 1], 'Tag','IpMarkXEcart',...
        'Callback',@Papa.marklesecart, 'Position',[posx+large posy largef haut], ...
  ...
  uicontrol('Parent',fig, 'Tag','IpMarkY', 'Callback',@Papa.marklesy, 'Style','checkbox', ...
