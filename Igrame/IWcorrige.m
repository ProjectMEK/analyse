...
function fig =IWcorrige(Ppa)
  ...
  uicontrol('Parent',fig, 'tag','CNouvCan', 'Position',[posx posy large haut], 'FontSize',9, ...
            ...
            'Style','checkbox', 'Value',Ppa.ecraser, 'Callback',@Ppa.OnEcrase);
  ...
  uicontrol('Parent',pan, 'Style','listbox', 'FontSize',10, 'Position',[posx posy large haut], 'Tag','LbCanaux', 'Min',1, ...
            'Max',letop, 'Fontname','courier', 'String',hdchnl.Listadname, 'Callback',@Ppa.CualCanEs, 'BackgroundColor',[1 1 1], ...
  ...
  uicontrol('Parent',pan, 'Position',[posx posy large haut], 'String','Tous les essais', ...
            'Style', 'radiobutton', 'Value',Ppa.Ess, 'tag','CEssTous', 'Callback',@Ppa.ChangeEss, ...
  ...
  gBout =uibuttongroup('Parent',pan, 'Units','pixels', 'Position',[posx posy large haut], ...
                       'Tag','GroupBtn', 'SelectionChangeFcn',@Ppa.Voirpoints);
  ...
  uicontrol('Parent',pan, 'tag','CDebFin', 'BackgroundColor',[0.8 0.8 0.8], ...
            ...
            'Style','radiobutton', 'Value',Ppa.DebFin, 'Callback',@Ppa.VoirDebFin);
  % UTILISER POLYNOMIAL FIT
  posy =posy-haut-my2;
  uicontrol('Parent',pan, 'tag','CPolyFit', 'Callback',@Ppa.Voirpoly, 'Style','checkbox', ...
  ...
  % AU TRAVAIL
  uicontrol('Parent',pan, 'Callback',@Ppa.AuTravail, 'Position',PosTrav, 'String','Au travail', ...
  ...
  %-------------------------------------
  uicontrol('Parent',pan, 'tag','Cprecise_critere', 'Position',[posx posy large haut], 'Callback',@Ppa.toggleCritere, ...
  ...
  uicontrol('Parent',pan, 'tag','CValeurCritere', 'BackgroundColor',[1 1 1], 'Style','edit', ...
            'Position',[posx+La posy Lb haut], 'String', '0', 'Callback',@Ppa.valeurCritere,...
