...
%
  ...
  uicontrol('Parent',lepan, 'tag','IpFrameEnleverpt', 'Position',[posx posy largeur hauteur], ...
            'Callback','wtoul(''enleve_marque'')', 'TooltipString',ML.pbdelpttip,...
            'String','...', 'Style','popupmenu', 'Value',1);

  % bouton pour le marquage manuel
  posx=posx+largeur+espd; largeur=0.07;
  uicontrol('Parent',lepan, 'tag','IpFrameMarquerpt', 'Callback','wtoul(''outil_marque'')', ...
  ...
  uicontrol('Parent',lepan, 'tag','IpFrameAfficherCoord', 'Callback','wtoul(''affichecoord'')', ...
  ...
  Ppa.Bcano(1) =uicontrol('Parent',pp, 'tag','IpCanPrecedent',...
            'Callback','wtoul(''canal_precedent'')', ...
  ...
  textcan ={'Parent';pp; 'BackgroundColor';[1 1 1]; 'Position';[posx posy largeur hauteur]; 'Style';'listbox'; ...
           'Callback';'wtoul(''choix_canaux'')'; 'Fontname';'courier'; 'String';lesnoms; 'Min';1; 'Max';1};  %'tag';'IpCanLesnoms';
  ...
  textess ={'Parent';pp; 'BackgroundColor';[1 1 1]; 'Fontname';'courier';...
           'Position';[posx posy largeur hauteur]; 'Callback';'wtoul(''choix_essai'')'; ...
  ...
  textcat ={'Parent';pp; 'tag';'IpCatsLesnoms'; 'BackgroundColor';[1 1 1]; ...
          'FontSize';lafonte1; 'Position';[posx posy largeur hauteur]; 'Callback';'wtoul(''niveau'')'; ...
