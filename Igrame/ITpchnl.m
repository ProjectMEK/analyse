...
function ITpchnl()
  ...
  Fig =figure('Name', 'AU FIL DU TEMPS', 'Position',lapos, ...
          'CloseRequestFcn',@tpchnl.FermerEdit,...
  ...
  uicontrol('Parent',Fig, 'tag','PmnuEchelDispo', 'Position',[25 hauteur flarg-50 25], ...									%
          'String',dep, 'Callback',@tpchnl.QuelEchel, 'Style','popupmenu', 'Value',1);
  hauteur =hauteur-45;
  uicontrol('Parent',Fig, 'HorizontalAlignment','Center', 'Style','text',...
  ...
  uicontrol('Parent',Fig, 'tag','ETleCanal', 'BackgroundColor',[1 1 1], ...
          ...
          'Callback',@tpchnl.ChangeCanal, 'Max',1, 'Style','listbox', 'Value',lecanal);
  ...
  xpos =flarg2-130;
  uicontrol('Parent',Fig, 'Callback',@tpchnl.Ajouter, 'Position',[xpos hauteur 100 25], 'String','Ajouter');
  hauteur =hauteur-50;
  uicontrol('Parent',Fig, 'Callback',@tpchnl.Modifier, 'Position',[xpos hauteur 100 25], 'String','Modifier');
  hauteur =hauteur-50;
  uicontrol('Parent',Fig, 'Callback',@tpchnl.Supprimer, 'Position',[xpos hauteur 100 25], 'String','Supprimer');
