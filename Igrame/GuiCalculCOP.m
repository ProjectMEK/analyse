...
function fig =GuiCalculCOP(Ppa)
  ...
  pan =uipanel('Parent',fig, 'Tag','PanelCanaux', 'title','Canaux', 'Position',posPan, ...
    ...
    posx =dx; large =lpan-2*posx; haut =hbout; posy =posy-haut-2*dy2;
    ...
    % EXPORTER PARAMÈTRES
    large =2*lbout; posx =round((lpan-large)/2); haut =hbout; posy =posy-haut-2*dy2;
...
function t =lireLeHelp(nouveau)
  if nouveau
      t ={' '; ...
          ...
          '_____________'; ...
          'Onglet Canaux '; ...
          'Le bouton -Importer param-  vous permet de charger les paramètres à partir d''un fichier.'; ...
          ' '; ...
          'Le bouton -Exporter param-  vous permet de sauvegarder les paramètres dans un fichier.'; ...
          ' '; ...
          'Une fois exporté, les paramètres peuvent être modifiés avec un éditeur de texte.'; ...
          '_________________'; ...
          'Unités CpX et CpY '; ...
      ...
      t ={' '; ...
          ...
          ' '; ...
          ' '; ...
          'Initié en Janvier 2002,'; ...
          'par M. Simoneau, laboratoire GRAME, U. Laval'};
  end
end