...
function varargout =langue_es(varargin)
  if nargout | nargin
    ...
    S.mnuip.modifsuppcan ='Eliminar canal';
    ...
    S.guipref.ongenlang ='Nombre de archivo del idioma de trabajo (directorio "doc"): ';
    ...
    S.guipref.ongenerrmnu ={'No se repite', 'Mensajes completos', 'Mensaje parcial'};
    ...
    S.guipref.onaffpttyp ={'Ocultarlos', 'Mostrarlos con información', 'Mostrarlos sin información'};
    ...
    S.guipref.onotp4 =sprintf(['\nEn la pestaña "Visualización", hay dos columnas: "Bloqueo config." (BC) y ' ...
                    '"Activado si se marca" (AM). Si marca la columna "BC" usted ' ...
                    'se impone sobre el valor de la casilla "AM" para esta variable.']);
    S.guipref.onotp5 =sprintf(['\nPor contra, si no marque la casilla de la columna "BC", el valor ' ...
                    'Para esta variable será la cuando cierre la aplicación.' ...
                    '\n\n(Por ejemplo, la línea de "Activar el zoom"' ...
                    '\n  con la casilla "BC" marcada' ...
                    '\n    Con casilla "AM" marcada: el zoom se activará' ...
                    '\n    Con casilla "AM" no marcada: el zoom estará inactivo' ...
                    '\n\n  con la casilla "BC" no marcada' ...
                    '\n    Al final de análisis, el estado de zoom va' ...
                    '\n    a decidir el valor en la próxima apertura.)']);
