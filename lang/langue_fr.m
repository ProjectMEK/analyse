...
function varargout =langue_fr(varargin)
  if nargout | nargin
    ...
    S.guipref.ongenerrmnu ={'Aucun affichage', 'Message complet', ...
                          'Nom de la fonction+Titre du message', 'Titre du message seulement'};
    ...
    S.guipref.onaffpttyp ={'Masquer les points marqués', 'Afficher les points marqués avec texte', ...
                         'Afficher les points marqués sans texte'};
