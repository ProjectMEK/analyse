...
function varargout =langue_en(varargin)
  if nargout | nargin
    ...
    S.guipref.ongenerrmnu ={'Do not display', 'Full message', 'Partial message'};
    ...
    S.guipref.onaffpttyp ={'Hide points', 'Show points with text', 'Show points without text'};
    ...
    S.guipref.onotp4 =sprintf(['\nIn the "View" tab, there are two columns: "Lock Config." (LC) and ' ...
                    '"On if checked" (OC). If you check the box in the column "LC", ' ...
                    'you impose the value of the box "OC" for this variable.']);
    S.guipref.onotp5 =sprintf(['\nBy cons, if you do not check the box in the column "LC", the value ' ...
                    'for this variable will be the one when closing the application.' ...
                    '\n\n(For example, the line "Enable zoom"' ...
                    '\n  with "LC" checked' ...
                    '\n    if the "OC" is checked: Zoom will be enable at the opening' ...
                    '\n    if "OC" is unchecked: Zoom will be disable at the opening' ...
                    '\n\n  with "LC" unchecked' ...
